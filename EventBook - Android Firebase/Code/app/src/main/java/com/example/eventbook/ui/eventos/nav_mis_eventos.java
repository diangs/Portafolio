package com.example.eventbook.ui.eventos;
 ...
 * Use the {@link nav_mis_eventos#newInstance} factory method to
 * create an instance of this fragment.
 */
public class nav_mis_eventos extends Fragment {
    private RecyclerView rvMisEventos;
    public static EventosAdapter adapterMisEventos;
     ...
     * @return A new instance of fragment mis_eventos.
     */
    // TODO: Rename and change types and number of parameters
    public static nav_mis_eventos newInstance(String param1, String param2) {
        nav_mis_eventos fragment = new nav_mis_eventos();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvMisEventos = miView.findViewById(R.id.rv_publicaciones_principales);
        DividerItemDecoration dividerItemDecoration = new
                DividerItemDecoration(getContext(), DividerItemDecoration.VERTICAL);


        adapterMisEventos = new EventosAdapter(getContext(),1);
        ...
        rvMisEventos.setAdapter(adapterMisEventos);
        rvMisEventos.addItemDecoration(dividerItemDecoration);
    ...
    public static void llenarMisEventos() {
        db.collection("eventos")
                .orderBy("creacion", Query.Direction.DESCENDING)
                .whereEqualTo("propietario", mAuth.getCurrentUser().getEmail())
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
    ...
    private static void llenarAdapter() {
        for (int i = 0; i <= eventoArrayList.size()-1; i++) {
            adapterMisEventos.add(eventoArrayList.get(i));
        }
    }
    public static void updateEventos(Evento evento, int numEvento) {
        adapterMisEventos.updateEvento(evento, numEvento);
    }
